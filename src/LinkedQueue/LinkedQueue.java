   ...
   public void add(E item)
   {
	  ...
	  rear = front;
       ...
       {  // Insert an item that is not the first.
          rear.addNodeAfter(item); // makes sure the last node has a link to the new node
          rear = rear.getLink( );  // the new node will be the rear        
       }
       manyNodes++;
   }
...
public Lister<Integer> iterator() {
	// TODO Auto-generated method stub
	return new Lister<Integer>((Node<Integer>) front);
}
