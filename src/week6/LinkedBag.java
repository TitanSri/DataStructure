...
* @see LinkedBag
******************************************************************************/
public class LinkedBag<E> implements Cloneable, Iterable<E>, Comparable<E>
{
   ...
   **/
   ...
   public void print()
   {
	   for(Node<E> selection = head; selection!=null; selection = selection.getLink())
		   System.out.print(selection.getData());
   }
   ...
   private void recursivePrintForward(Node<E> head2) {
	//base condition
	   if(head2!=null) {
		   System.out.println(head2.getData());
		   recursivePrintForward(head2.getLink());
	   }	
   }
   public void printBackward()
   {
	   recursivePrintBackward(head);
   }

   private void recursivePrintBackward(Node<E> head2) {
	   if(head2!=null) {		   
		   recursivePrintBackward(head2.getLink());
		   System.out.println(head2.getData());
	   }
...
public Node<E> search(int target)
   {
	   for(Node<E> selection=head; selection != null; selection = selection.getLink())
	   {
		   if(selection.getData().equals(target))
			   return selection;
	   }
	   return null;
   }
